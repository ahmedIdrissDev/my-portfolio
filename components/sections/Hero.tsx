  ...
  return (
    ...
    >
      <h1 className="max-w-[800px] relative  font-Ahmed mb-[var(--spacing-md)] font-normal flex flex-wrap justify-center text-4xl md:text-6xl">
        ...
        <svg className="absolute w-80 md:w-auto -right-8 md:right-0 -bottom-8 opacity-0 hero-draw-svg" width="491" height="111" viewBox="0 0 401 111" fill="none" xmlns="http://www.w3.org/2000/svg">
